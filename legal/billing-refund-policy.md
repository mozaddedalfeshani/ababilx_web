...
4. [Billing and Renewal](#4-billing-and-renewal)
5. [Payment Methods and Providers](#5-payment-methods-and-providers)
6. [Taxes](#6-taxes)
7. [Upgrades and Downgrades](#7-upgrades-and-downgrades)
8. [Cancellation](#8-cancellation)
9. [Plan Expiry Behavior](#9-plan-expiry-behavior)
10. [Refunds](#10-refunds)
11. [Failed Payments](#11-failed-payments)
12. [Chargebacks](#12-chargebacks)
13. [Price Changes](#13-price-changes)
14. [Invoices and Records](#14-invoices-and-records)
...
This Billing & Refund Policy governs payments for the AbabilX Service and forms part of our [Terms of Service](./terms-of-service.md). Terms defined there apply here.
...
Payments are processed by third-party payment providers. We do not store full card numbers or bank credentials; the provider transmits to us only confirmation of payment status and the records needed to manage your subscription (see [Privacy Policy](./privacy-policy.md), Section 6.1.5). You must have authority to use the payment method you provide, and you must keep it current.
...
3. does not by itself delete your Account or data (see [Privacy Policy](./privacy-policy.md), Section 14 for deletion).
...
3. **Material feature reduction** — as provided in the [Terms of Service](./terms-of-service.md), Section 15.3.
...
We do not refund: partial-cycle cancellations outside Section 10.2; dissatisfaction with AI Output quality (see [AI Policy](./ai-policy.md), Section 9); suspension or termination for violation of the [Acceptable Use Policy](./acceptable-use-policy.md) or [Terms of Service](./terms-of-service.md); or failure to cancel before a Renewal Date, except as goodwill at our discretion.
